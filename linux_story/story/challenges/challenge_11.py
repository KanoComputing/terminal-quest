...
class Step2(StepTemplateMv):
    story = [
        ...
        _("\"I learnt this spell for moving items from one place to another. But I can't seem to make it work.\""),
        _("\"I've been trying to move this}} {{bb:apple}} {{Bb:into the}} {{bb:basket}}{{Bb:\"}}"),
        _("{{Bb:\"I was told the command was}} {{yb:mv apple basket/}}{{Bb:\"}}"),
        _("{{Bb:\"But I don't understand what that means. Do I say it? Or write it?\"}}\n"),
        _(" ------------------------------------- "),
