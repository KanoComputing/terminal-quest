...
class Step1(StepTemplateCd):
    story = [
        ...
        _("Let's look for your Dad in the {{bb:garden}}."),
        _("First we need to {{lb:leave}} the kitchen using {{yb:cd ../}}\n")
    ]
...
class Step4(StepTemplateCd):
    story = [
        _("Use {{yb:ls}} to {{lb:look}} in the garden for your Dad.\n")
    ]
    start_dir = "~/my-house/garden"
    end_dir = "~/my-house/garden"
    commands = "ls"
    hints = (
        _("{{rb:To look for your Dad, type}} {{yb:ls}} {{rb:and press "
          "Enter.}}")
    )
...
class Step7(StepTemplateCd):
    story = [
        _("Your dad has been busy, there are loads of vegetables here."),
        _("Hmmmm. He's not here. But there is something odd."),
        _("You see a note on the ground.  Use {{yb:cat note}} to "
...
class Step9(StepTemplateCd):
    story = [
        ...
        _("{{gb:Top tip: Press the UP arrow key to replay your previous command.}}\n")
    ]
    start_dir = "~/my-house/garden"
    end_dir = "~/my-house"
    commands = ["cd ..", "cd ../"]
...
class Step10(StepTemplateCd):
    story = [
        _("Now {{lb:go}} back into the {{bb:kitchen}} and see Mum.\n")
    ]
    start_dir = "~/my-house"
